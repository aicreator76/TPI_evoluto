...
- Portare online il **Catalogo DPI** con API CSV.
- Preparare un **Modulo DPI demo** con cruscotto.
- Avviare il backend FastAPI con Alembic in modo stabile.
- Gettare le basi per doc tecnica e cruscotti per Regina/RSPP.
